...
public class OI {
    ...
    public Joystick joystickDrive = null; // new Joystick(0);
    public JoystickButton driveStraightButton;
    public JoystickButton turnToNinetyButton;

    public Joystick joystickOperator = new Joystick(0); // new Joystick(1);
    ...
    public OI() {
        ...
        // driveStraightButton = new JoystickButton(joystickDrive, 9);
