 ...
 */
public class UltrasonicMB1013 extends SendableBase {
    ...
    public UltrasonicMB1013(int channel) {
        super();
        m_rangefinder = new AnalogInput(channel);
    }

  /**
   * Get the distance to an obstacle in inches from the back of the sensor PCB board
   * to the face of the obstacle.
   *
